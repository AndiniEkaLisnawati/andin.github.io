alert('SELAMAT DATANG DI PERMAINAN SUIT JAWA');
    alert('PERATURAN BERMAIN :                                                                      GAJAH VS ORANG = MENANG GAJAH                                                   ORANG VS SEMUT = MENANG ORANG                                           SEMUT VS GAJAH = MENANG SEMUT');
let tanya = true;
while(tanya) {
  ...
  if(player == bot){
    hasil = 'Hasil permainan kamu seri';
  }else if(bot == 'semut'){
    if(player == 'orang'){
  ...
  alert("kamu milih "+player+", sedangkan Andin memilih "+bot+", makaaaa........... "+hasil);
